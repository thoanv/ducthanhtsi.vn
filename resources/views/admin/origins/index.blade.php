                        ...
                        <div>
                            <h4 class="card-title">
                                ...
                                @can('create', \App\Models\Origin::class)
                                    <a href="{{route('origins.create')}}" class="btn btn-primary btn-fw float-end">Thêm
                                        mới</a>
                                @endcan
                            </h4>
                                        ...
                                        <td role="cell" class="text-center">
                                            <div class="form-check form-switch" style="display: inline-block">
                                                <input name="my-checkbox" type="checkbox"
                                                       ...
                                                       data-api="{{route('enable-column')}}" data-table="origins"
                                                       data-column="status"
