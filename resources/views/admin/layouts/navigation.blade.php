...
{{--            </li>--}}
            <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-info create-new-button" id="createbuttonDropdown" target="_blank" href="{{route('home')}}">
                    <i style="font-size: 15px" class="mdi mdi-cast" aria-hidden="true"></i>
