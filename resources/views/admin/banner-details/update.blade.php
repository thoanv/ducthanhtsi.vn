...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <form class="theme-form" method="POST" action="{{route('banners_detail_update')}}">
                @csrf
                <input name="id" type="hidden" value="{{$bannerDetail['id']}}">
                <div class="row">
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="{{route('banners_detail_list', $bannerDetail['banner_id'])}}" class="btn btn-dark">Quay lại</a>
                                    </div>
                                </div>
                            </div>
                        </div>
